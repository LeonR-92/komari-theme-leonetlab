...
assert.equal(getLatencyToneClass(150), 'bg-lime-400')
assert.equal(getLossToneClass(0), 'bg-emerald-500')
assert.equal(getLatencyToneClass(201), 'bg-rose-500')
assert.equal(getLossToneClass(10), 'bg-rose-500')
